# Дизайн — test-автономный-режим-auto
...
- `changes/test-автономный-режим-auto/snippets/*` — подсказки реализации по задачам

## Допущения
- Scaffold project structure for test-автономный-режим-auto
