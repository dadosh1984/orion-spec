...
- `changes/csv-tool-import-export/snippets/*` — per-task implementation hints

## Assumptions
- Scaffold project structure for csv-tool-import-export
