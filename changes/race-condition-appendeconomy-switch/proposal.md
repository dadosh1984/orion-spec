# Proposal — race-condition-appendeconomy-switch
...
| Platform | node 22+ |
| Budget | compact |
| Constraints | zero-dependency; jsonl appendOnly; migrate existing economy.json to .jsonl; edit only src/core/compress.ts + tests |

- **Lessons applied (v0.12):** orion-spec:session:c97f28ad2b97, migrate-tool-e2e-pipeline:shield:2547efbb2c08, migrate-tool-e2e-pipeline:shield:7fa3ad4497fa, orion-spec:session:00ab5106ab99, orion-spec:session:6d9930aa64b5
