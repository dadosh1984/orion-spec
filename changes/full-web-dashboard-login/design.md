# Design — full-web-dashboard-login
...
- `changes/full-web-dashboard-login/snippets/*` — per-task implementation hints

## Assumptions
- Scaffold project structure for full-web-dashboard-login
