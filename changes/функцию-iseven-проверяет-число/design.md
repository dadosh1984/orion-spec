# Дизайн — функцию-iseven-проверяет-число
...
- `changes/функцию-iseven-проверяет-число/snippets/*` — подсказки реализации по задачам

## Допущения
- Scaffold project structure for функцию-iseven-проверяет-число
