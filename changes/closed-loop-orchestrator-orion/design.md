# Design — closed-loop-orchestrator-orion
...
- `changes/closed-loop-orchestrator-orion/snippets/*` — per-task implementation hints

## Assumptions
- Scaffold project structure for closed-loop-orchestrator-orion
