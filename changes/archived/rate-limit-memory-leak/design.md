...
- `changes/rate-limit-memory-leak/snippets/*` — per-task implementation hints

## Assumptions
- Scaffold project structure for rate-limit-memory-leak
