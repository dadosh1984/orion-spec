...
- `changes/orion-chat-one-command/snippets/*` — per-task implementation hints

## Assumptions
- Scaffold project structure for orion-chat-one-command
