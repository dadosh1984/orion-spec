# Дизайн — улучшить-производительность-запросов
...
- `changes/улучшить-производительность-запросов/snippets/*` — подсказки реализации по задачам

## Допущения
- Scaffold project structure for улучшить-производительность-запросов
