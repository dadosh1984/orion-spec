# Design — benchmark-10-different-orion
...
- `changes/benchmark-10-different-orion/snippets/*` — per-task implementation hints

## Assumptions
- Scaffold project structure for benchmark-10-different-orion
