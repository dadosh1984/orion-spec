...
- `changes/v0-46-устранить-дубли/snippets/*` — подсказки реализации по задачам

## Допущения
- Scaffold project structure for v0-46-устранить-дубли
