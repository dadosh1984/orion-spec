...
- `changes/json-output-mode-orion/snippets/*` — per-task implementation hints

## Assumptions
- Scaffold project structure for json-output-mode-orion
