# Дизайн — навык-skill-команду-orion
...
- `changes/навык-skill-команду-orion/snippets/*` — подсказки реализации по задачам

## Допущения
- Scaffold project structure for навык-skill-команду-orion
