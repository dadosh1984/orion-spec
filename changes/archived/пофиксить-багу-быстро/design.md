...
- `changes/пофиксить-багу-быстро/snippets/*` — подсказки реализации по задачам

## Допущения
- Scaffold project structure for пофиксить-багу-быстро
