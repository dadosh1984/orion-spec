# Design — socrates-engine-rule-based
...
- `changes/socrates-engine-rule-based/snippets/*` — per-task implementation hints

## Assumptions
- Scaffold project structure for socrates-engine-rule-based
